...
function tellJoke(){
    const jokeLine = getRandomData("jokes");
    const jokeContainer = document.querySelector(".joke-content");
    const newJoke = document.createElement("p");
    newJoke.textContent = jokeLine;
...
function giveQuote() {
    const quoteText = getRandomData("quotes");
    const quoteContainer = document.querySelector(".quote-content");
    const newQuote = document.createElement("p");
    const newAuthor = document.createElement("p");
    newQuote.textContent = quoteText.quote;
    newAuthor.textContent = "-" + quoteText.author;
...
function askRiddle() {
    const riddleText = getRandomData("riddles");
    const riddleContainer = document.querySelector(".riddle-content");
    const newRiddle = document.createElement("p");
    const newRiddleAnswer = document.createElement("p");
    newRiddle.textContent = riddleText.question;
    newRiddleAnswer.textContent = "-" + riddleText.answer;
...
function tellAnswer() {
    const riddleAnswerText = document.querySelector(".riddle-content");
    const riddle = riddleAnswerText.querySelector("p");
    ...
    else alert("First see the riddle...");
